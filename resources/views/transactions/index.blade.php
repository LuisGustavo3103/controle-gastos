            ...
            <div class="bg-white rounded-2xl p-5 mt-3">
                ...
                @foreach ($transactions as $transaction)
                    <div class="flex justify-between bg-gray-100 p-2 rounded-md items-center mt-2">
                        ...
                        @if (TypeTransactionEnum::RECEIVED === $transaction->type)
                            <p class="text-green-500 font-bold">+ R$ {{ number_format($transaction->amount, 2, ',', '.') }}
                            </p>
                        @elseif (TypeTransactionEnum::SENT === $transaction->type)
